...
WITH raw_transactions AS (
    SELECT * FROM read_parquet('{{ var("data_path", "../data/production") }}/transactions.parquet')
)
...
SELECT
    ...
    CAST(base_amount AS INTEGER) AS base_amount,
    CAST(discounted_amount AS INTEGER) AS discounted_amount,
